...
import FileUploadModal from "./UploadWindow"; 
...
const FileManagementPage: React.FC = () => {
  ...
  const fetchFileList = async (): Promise<void> => {
    try {
      ...
      // Assume the API returns a format like { unmatchedRecords: FileItem[] }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <FileUploadModal
            isOpen={false} // Control modal visibility according to actual state
            onClose={() => {}}
